...
The visual style should feel like a practical desktop utility with clean, high-recognition item icons. Tool, weapon, and armor icons should use material-inspired colors, such as brown wood, silver iron, gold, cyan diamond, and dark netherite. It should not mimic official Minecraft branding or use official logos/textures.
